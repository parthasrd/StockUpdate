...
if(trim($_REQUEST['fid'])!='')
{
    ...
    unset($feed_other_param["title"]);
    unset($feed_other_param["variants-price"]);
...
<!-- Default structure -->
    ...
    <input type="hidden" id="metanum" value="<?php echo $metafield_count; ?>">
                                    ...
                                    <div class="feild-right top-blank">
                                        <div class="custom-select"> 
                                          <select name="mapping['values'][]">
                                            ...
                                            foreach ($field_title_list as $key => $data) {
                                            ?>
                                            <option value="<?php echo $data; ?>" <?php if($data == $title){ ?> selected="selected" <?php } ?>><?php echo $data; ?></option>
                                            <?php
                                            }
                                            ?>
                                          </select>
                                    ...
                                    <div class="feild-right top-blank">
                                        <div class="custom-select">
                                          <select name="mapping['values'][]">
                                            ...
                                            foreach ($field_title_list as $key => $data) {
                                            ?>
                                            <option value="<?php echo $data; ?>"<?php if($data == $price){ ?> selected="selected" <?php } ?>><?php echo $data; ?></option>
                                            <?php
                                            }
                                            ?>
                                          </select>
