...
if($edit_fid!=''){
    ...
    $ftp_user = (trim($data->ftp_user)!='') ? trim($data->ftp_user) : '';
    $ftp_pwd = (trim($data->ftp_pwd)!='') ? trim($data->ftp_pwd) : '';
    $ftp_host = (trim($data->ftp_host)!='') ? trim($data->ftp_host) : '';
    $ftp_dir_path = (trim($data->ftp_dir_path)!='') ? trim($data->ftp_dir_path) : '';
...
<div class="feed-setting-box-sec">
    <ul class="feed-setting-header">
        <li><span> <img src="assets/images/ftp-icon.png" alt="ftp-icon"></span> <p>FTP - Download </p></li>
    ...
    <div class=" col-sm-10 col-sm-offset-1">
        <div class="feild-form-box">
                ...
                <div class="col-sm-9 no-padding">
                    <select id="method_changer" class="form-control" name="connection_method" required>
                        ...
                        foreach ($feed_methods as $key => $val){
                            $selected = ($val->php_file_name == 'ftp.php') ? 'selected' : '';
                            ?>
                    ...
                    <!-- <select id="method_changer" class="form-control" name="connection_method" required>                        
                            <option value="ftp.php" selected >FTP</option>
                    </select> -->
                </div>
            </div>
            <div class="feild-left">
                ...
                <div class="col-sm-9 no-padding">
                    <div class="feild-input">
                      <input type="text" id="ftp_user" name="ftp_user" class="form-control" placeholder="" value="<?php echo $ftp_user; ?>" required>
                    </div>
                </div>
            </div>
            <div class="feild-left">
                ...
                <div class="col-sm-9 no-padding">
                    <div class="feild-input">
                      <input type="password" id="ftp_pwd" name="ftp_pwd" class="form-control" placeholder="(Use Save password)"  value="<?php echo $ftp_pwd; ?>" required>
            ...
            <div class="feild-left">
                ...
                <div class="col-sm-9 no-padding">
                    <div class="feild-input">
                      <input type="text" id="ftp_host" name="ftp_host" class="form-control" placeholder="" value="<?php echo $ftp_host; ?>" required>
                    </div>
            ...
            <div class="feild-left">
                ...
                <div class="col-sm-9 no-padding">
                    <div class="feild-input">
                      <input type="text" id="ftp_dir_path" name="ftp_dir_path" class="form-control" placeholder="" value="<?php echo $ftp_dir_path; ?>" required>
                    </div>
